...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "www", "im", "tty", "mail", "vm", "fm", "ftp", "docs", "misc" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "j", function () awful.screen.focus(config.screenJ) end,
              {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus(config.screenK) end,
              {description = "focus the previous screen", group = "screen"}),
    awful.key({ modkey, "Control" }, "i", function () awful.screen.focus(config.screenI) end,
              {description = "focus the previous screen", group = "screen"}),
    ...
    -- awful.key({ "Control", modkey, }, "l", function () awful.spawn.with_shell('i3lock -t -i '..os.getenv("HOME").."/Pictures/lock-screen.png") end)
)
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "0",      function (c) c:move_to_screen(2)               end,
              {description = "move to screen", group = "client"}),
    awful.key({ modkey,           }, "i",      function (c) c:move_to_screen(1)              end,
              {description = "move to screen", group = "client"}),
    awful.key({ modkey,           }, "o",      function (c) c:move_to_screen(3)              end,
              {description = "move to screen", group = "client"}),
