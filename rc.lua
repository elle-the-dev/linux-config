...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "0",      function (c) c:move_to_screen(config.screenI)               end,
              {description = "move to screen", group = "client"}),
    awful.key({ modkey,           }, "i",      function (c) c:move_to_screen(config.screenJ)              end,
              {description = "move to screen", group = "client"}),
    awful.key({ modkey,           }, "o",      function (c) c:move_to_screen(config.screenK)              end,
              {description = "move to screen", group = "client"}),
